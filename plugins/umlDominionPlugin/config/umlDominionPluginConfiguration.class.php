...
class umlDominionPluginConfiguration extends sfPluginConfiguration
{
    public static $summary = 'Custom UML theme derived from arDominionPlugin';
    ...
    public function contextLoadFactories(sfEvent $event)
    {
        ...
        if ($context->getConfiguration()->isDebug()) {
            ...
            $context->response->addStylesheet('/plugins/umlDominionPlugin/css/main.less', 'last', ['rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all']);
        } else {
            $context->response->addStylesheet('/plugins/umlDominionPlugin/css/main.css', 'last', ['media' => 'all']);
        }
    }
