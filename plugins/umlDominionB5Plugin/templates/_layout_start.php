...
<html lang="<?php echo $sf_user->getCulture(); ?>" dir="<?php echo sfCultureInfo::getInstance($sf_user->getCulture())->direction; ?>">
  <head>
    ...
    <script defer src="/dist/js/vendor.bundle.51cf3c3989802bda6211.js"></script><script defer src="/dist/js/umlDominionB5Plugin.bundle.44d4e6bf71dfa37e8ae7.js"></script><link href="/dist/css/umlDominionB5Plugin.bundle.4e4cf476c49278965f5d.css" rel="stylesheet">
