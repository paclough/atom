...
{
    public static $summary = 'Custom UML theme with Bootstrap 5, derived from arDominionB5Plugin';
    ...
    public function initialize()
    {
        ...
        if (false !== $key = array_search('umlDominionB5Plugin', $plugins)) {
            unset($plugins[$key]);
        }
        $this->configuration->setPlugins(
            array_merge(['umlDominionB5Plugin'], $plugins)
        );
